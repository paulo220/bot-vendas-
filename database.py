...
CREATE TABLE IF NOT EXISTS bot_config(
    lara_name TEXT DEFAULT 'Pedro Henrique da silva santos',                 -- Nome da lara
    lara_key TEXT DEFAULT 'a1e6ace3-8a50-4471-ac19-e3079c51891d',                                        -- Chave pix da lara
    main_img TEXT DEFAULT 'https://telegra.ph/file/f0ac7b4baf2ed34c51747.png',  -- Link da imagem do /start
    support_user TEXT DEFAULT '@MatheusKitado',                               -- Username de atendimento
    channel_user TEXT DEFAULT '@YakuzaaStoree',                                    -- Canal de notícias
